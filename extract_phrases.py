...
def ratios(sentence_list):
    ...
    ngrams = [x for x in ngrams_of_sents(sentence_list,2)]
    print >> sys.stderr, 'number of ngrams', len(ngrams)
...
class Phrasifier():
    ...
    def __init__(self, filepath):
        for line in csv.reader(open(filepath), delimiter='\t'):
